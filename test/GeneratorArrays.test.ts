    ...
    suite("Equal chances", () => {
        ...
        suite("Invalid input", () => {
            test("Length not an integer", () => {
                expect(() => GenerateArray.generators(1.2, validGenerators)).to.throw("Array length must be an" +
                    " integer: value '1.2' is invalid");
            });

            test("Length of 0", () => {
                expect(() => GenerateArray.generators(0, validGenerators)).to.throw("Array length must be greater" +
                    " than 0 to generate array");
            });

            test("Negative length", () => {
                expect(() => GenerateArray.generators(-7, validGenerators)).to.throw("Array length must be greater" +
                    " than 0 to generate array");
            });

            test("No generators", () => {
                expect(() => GenerateArray.generators(1, [])).to.throw("No generators provided to create array");
            });
        });
